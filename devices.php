...
if( isset($_POST['id_to_delete']) && $_POST['id_to_delete']!="") {
  ...
  $conn->query("DELETE FROM `admin_chia4iot`.`devices` WHERE  `devices_id`=$id_to_delete");
}
...
<head>
  ...
  <link rel="shortcut icon" sizes="196x196" href="assets/images/logchia.png">
      ...
      <div class="left navside dark dk" data-layout="column">
        <div class="navbar no-radius">
          ...
          <a class="navbar-brand">
            ...
            <span class="hidden-folded inline">Chia 4.0</span>
          </a>
          <!-- / brand -->
        </div>
          ...
          <div class="nav-fold">
            <a href="profile.html">
              ...
              <span class="clear hidden-folded p-x">
                <span class="block _500">Fernando Chanduvi</span>
                ...
                <div class="box-body">
                  ...
                  <form role="form" method="post" target="">
                    <div class="form-group">
                      ...
                      <input name="alias" type="text" class="form-control" placeholder="Ej: Medidor de temperatura">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Serie</label>
                      <input name="serie" type="texzt" class="form-control" placeholder="Ej: A12356">
                    </div>
