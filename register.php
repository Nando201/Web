...
//Conexion a data basae
$conn = mysqli_connect("localhost","admin_chia4iot","aws12345chiaiot4.0","admin_chia4iot");
  ...
  <div class="center-block w-xxl w-auto-xs p-y-md">
    ...
    <div class="p-a-md box-color r box-shadow-z1 text-color m-a">
      ...
      <form method="post" target="register.php" name="form">
        ...
        <button type="submit" class="btn primary btn-block p-x-md">Registrate</button>
      </form>
...
<br>
    <div class="p-v-lg text-center">
      <div>Ya tienes una cuenta? <a ui-sref="access.signin" href="login.php" class="text-primary _600">Iniciar sesion</a></div>
    </div>
  </div>
